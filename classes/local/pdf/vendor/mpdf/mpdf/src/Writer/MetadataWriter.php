...
class MetadataWriter implements \Psr\Log\LoggerAwareInterface {
    ...
    public function writeMetadata() // _putmetadata
    {
        ...
        $Producer = 'Eduardo Kraus - ' . ($this->mpdf->exposeVersion ? (' ' . Mpdf::VERSION) : '');
        $z = date('O'); // +0200
    ...
    {
        $this->writer->write('/Producer ' . $this->writer->utf16BigEndianTextString('Eduardo Kraus - ' . ($this->mpdf->exposeVersion ? (' ' . $this->getVersionString()) : '')));
