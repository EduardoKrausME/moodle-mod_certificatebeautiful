...
<head>
    ...
    <link rel="stylesheet"
          href="https://fonts.googleapis.com/css2?family=DM+Serif+Display:ital@0;1&family=Lato:ital,wght@0,100;0,300;0,400;0,700;0,900;1,100;1,300;1,400;1,700;1,900&family=Montserrat:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&family=Open+Sans:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;1,300;1,400;1,500;1,600;1,700;1,800&family=Parisienne&family=Playfair+Display:ital,wght@0,400;0,500;0,600;0,700;0,800;0,900;1,400;1,500;1,600;1,700;1,800;1,900&display=swap">
    <link rel="stylesheet"
          href="https://fonts.googleapis.com/css2?family=Abhaya+Libre:wght@400;500;600;700;800&family=Alex+Brush&family=Cinzel:wght@400;500;600;700;800;900&family=Montserrat:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&family=Raleway:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap">
...
<div id="gjs" style="height:0; overflow:hidden">
    ...
    echo "{$pageinfo->htmldata}<style>[data-gjs-type=wrapper] > * * {position: initial !important;}{$pageinfo->cssdata}</style>";
    ?>
</div>
...
<script type="text/javascript">
    ...
    editor.on('update', function() {
        $("#form-htmldata").val(editor.getHtml());
        $("#form-cssdata").val(editor.getCss());
        $("#form-save").show(300);

        $("#testpdf-htmldata").val(editor.getHtml());
        $("#testpdf-cssdata").val(editor.getCss());
    ...
    editor.Panels.addPanel({id : "devices-c"}).get("buttons").add([
        {
            id        : "block-testpdf",
            command   : "block-testpdf",
            className : "btn-testpdf padding-0",
            label     : `<form id="save-form" method="post" target="_top"
                               action="test-pdf.php?id=<?php echo $id ?>&page=<?php echo $page ?>">
                             <input type="hidden" name="sesskey" value="<?php echo sesskey() ?>">
                             <input type="hidden" name="htmldata" id="test-htmldata">
                             <input type="hidden" name="cssdata" id="test-cssdata">
                             <button type="submit" class="btn-salvar gjs-pn-btn gjs-pn-active gjs-four-color">
                                <?php echo get_string('grapsjs-certificate_page_test', 'certificatebeautiful') ?>
                            </button>
                         </form>`,
    ...
    editor.Commands.add('block-testpdf', {
        run : function(editor, sender) {
            sender && sender.set('active', 0);
            editor.store();

            document.getElementById("test-htmldata").value = editor.getHtml();
            document.getElementById("test-cssdata").value = editor.getCss();
