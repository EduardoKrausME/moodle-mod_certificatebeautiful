...
!function(e, t) {
    ...
    var e = {
        241    : e => {
            ...
            "use strict";
            let {SourceMapConsumer : r, SourceMapGenerator : i} = s(209), {fileURLToPath : n, pathToFileURL : o} = s(414), {resolve : l, isAbsolute : a} = s(830), {nanoid : h} = s(961),
                u = s(868), c = s(671), p = s(981),
                f = Symbol('fromOffsetCache'), d = Boolean(r && i),
                m = Boolean(l && a);
            ...
            "use strict";
            let {SourceMapConsumer : r, SourceMapGenerator : i} = s(209), {dirname : n, resolve : o, relative : l, sep : a} = s(830), {pathToFileURL : h} = s(414),
                u = s(995), c = Boolean(r && i),
                p = Boolean(n && o && l && a);
            e.exports = class {
                constructor(e, t, s, r) {
            ...
            "use strict";
            let {SourceMapConsumer : r, SourceMapGenerator : i} = s(209), {existsSync : n, readFileSync : o} = s(777), {dirname : l, join : a} = s(830);
