...
!function(e, t) {
    ...
    var o = 'custom-code-plugin__code', n = 'custom-code', i = 'custom-code:open-modal',
    ...
    const d = function(e, t) {
        ...
        var d = c({
            ...
            placeholderScript    : "<div style=\"pointer-events: none; padding: 10px;\"><svg viewBox=\"0 0 24 24\" style=\"height: 30px; vertical-align: middle;\"><path d=\"M13 14h-2v-4h2m0 8h-2v-2h2M1 21h22L12 2 1 21z\"></path></svg>Custom code with <i>&lt;script&gt;</i> can't be rendered on the canvas</div>",
        ...
        !function(e, t) {
                ...
                model   : {
                    defaults                    : r({
                        ...
                        c && !t.filter((function(e) {
                            ...
                            id      : n,
                            command : i,
                            label   : "<svg viewBox=\"0 0 24 24\"><path d=\"M14.6 16.6l4.6-4.6-4.6-4.6L16 6l6 6-6 6-1.4-1.4m-5.2 0L4.8 12l4.6-4.6L8 6l-6 6 6 6 1.4-1.4z\"></path></svg>"
                        }, c))
            ...
            o && i.add(n, s({
                label    : 'Custom Code',
                media    : "<svg viewBox=\"0 0 24 24\"><path d=\"M14.6 16.6l4.6-4.6-4.6-4.6L16 6l6 6-6 6-1.4-1.4m-5.2 0L4.8 12l4.6-4.6L8 6l-6 6 6 6 1.4-1.4z\"></path></svg>",
                category : 'Basic',
                activate : !0,
                select   : !0,
                content  : {type : n}
