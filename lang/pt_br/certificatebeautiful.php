...
$string['autogenerate_help'] = 'Quando ativado, a tarefa agendada criará automaticamente emissões de certificados e arquivos PDF.';
...
$string['config_data_protect_desc'] = 'Marque para anonimizar os dados pessoais no validador de certificados';
...
$string['config_signature_enable_desc'] = 'Quando marcado, o Beautiful Certificate criará uma assinatura personalizada com base na caligrafia escolhida, no texto informado e na cor.';
...
$string['config_signature_text_desc'] = 'Para ativar a geração automática de assinaturas pelo Beautiful Certificate, é necessário informar uma sequência de até 10 caracteres. Certifique-se de que a sequência não contenha espaços, números ou acentos. Uma sequência composta por 5 a 7 caracteres produzirá uma assinatura visualmente agradável.';
$string['config_signature_typography'] = 'Estilo do Texto da Assinatura';
$string['config_signature_typography_desc'] = 'Por padrão, o Beautiful Certificate gerará uma assinatura usando o texto abaixo e utilizará esta caligrafia para personalizar o conteúdo.';
$string['course'] = 'Curso';
...
$string['gradepass_required'] = 'Você deve definir uma nota final mínima numérica para o curso.';
...
$string['privacy:metadata:certificatebeautiful_issue'] = 'Informações sobre os certificados emitidos aos usuários.';
...
<p>Envie uma nova imagem para substituir o fundo do certificado.</p>
<p>O certificado está no formato <strong>{$a->orientation}</strong>, e a imagem deve ter dimensões de <strong>{$a->size} pixels</strong>, correspondentes a <strong>{$a->sizecm} cm</strong>. Certifique-se de manter essas proporções para evitar distorção ou pixelização.</p>
</div>';
