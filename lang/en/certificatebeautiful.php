...
$string['default-description'] = 'This certificate confirms that the student <b>{$USER->fullname}</b> has successfully completed the <b>{$course->fullname}</b> with distinction, consolidating a comprehensive set of knowledge and skills essential for excelling in dynamic environments.';
